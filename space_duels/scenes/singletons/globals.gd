...
# Scene paths
export var main_menu_path = "res://scenes/runnable/main_menu.tscn"
export var lobby_menu_path = "res://scenes/runnable/lobby_menu.tscn"
export var main_path = "res://scenes/runnable/main.tscn"

...
export var join_scene_path = "res://scenes/runnable/join_menu.tscn"
export var create_scene_path = "res://scenes/runnable/create_menu.tscn"
export var test_scene_path = "res://scenes/runnable/test.tscn"
...
func _input(event):
	...
	if event.is_action_released("ui_test"):
		get_tree().change_scene(test_scene_path)
